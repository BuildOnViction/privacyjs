...
//     it('Should gen/verify correctly 10b', (done) => {
//         const EC = genECPrimeGroupKey(10);
//         const a = _.map(Array(10), () => BigInteger.fromHex(
//             randomHex(),
//         ).mod(secp256k1.n));
//         const b = _.map(Array(10), () => BigInteger.fromHex(
//             randomHex(),
//         ).mod(secp256k1.n));
