 ...
 * It is chosen arbitrarily such that it is impossible to know the discrete log with respect to G (i.e. there is some x such that xG == H,
...
class Commitment{
    ...
    static genCommitmentFromTxPub (amount, txpub, privateViewKey, encoded = true) {
        let lfTx = ecparams.pointFromX(parseInt(txpub.YBit) % 2 == 1, 
